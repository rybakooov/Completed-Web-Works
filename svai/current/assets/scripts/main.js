...
/* price up-down */
$(document).ready(function(){
	$(document).on('click', '.price-aside__title', function(){
		$(this).closest('.price-aside').toggleClass('active');
		$(this).closest('.price-aside').find('ul').slideToggle('fast');
	})

	
	$(document).on('click', '.proj-aside__title', function(){
		$(this).closest('.proj-aside').toggleClass('active');
		$(this).closest('.proj-aside').find('ul').slideToggle('fast');
	})
})
/* price up-down end */