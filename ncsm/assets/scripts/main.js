$(document).ready(function () {
  ...
  if($('.otdel-geoslider').length){
    $('.otdel-geoslider').slick({
      ...
      slidesToScroll: 1,
      //variableHeight: true,
      prevArrow: '<div class="otdel-geoslider__prev"><img src="assets/templates/csm/images/arrow_right--lightgray.svg" alt="" /></div>',
      nextArrow: '<div class="otdel-geoslider__next"><img src="assets/templates/csm/images/arrow_right--lightgray.svg" alt="" /></div>',
      responsive: [
        {
          breakpoint: 1023,
          settings: {
  ...
  $(document).on('change', 'input[type="file"]', function (e){
    e.target.files[0] = '';
    $(this).closest('.job-box').find('.job-form__box').html(e.target.files[0].name);
  ...
  $(document).on('click', '.search_full-main-aside-li_hassub > span', function(){
    $(this).toggleClass('active');
    $(this).closest('.search_full-main-aside-li_hassub').find('.search_full-main-aside-ul_sub').slideToggle();
  })
